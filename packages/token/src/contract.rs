...
use cw20_base::contract::{
    ...
    execute_upload_logo, query_balance, query_minter, query_download_logo, query_marketing_info, execute_burn,
};

use crate::query::{ query_get_token_info };
// version info for migration info
const CONTRACT_NAME: &str = "inj-token";
...
pub fn instantiate(
    ...
    Ok(cw20_base::contract::instantiate(
        ...
        cw20_base::msg::InstantiateMsg {
            name: msg.name.clone(),
            symbol: msg.name.clone(),
            decimals: msg.decimal,
            initial_balances: [
                cw20::Cw20Coin {
            ...
            mint: Some(cw20::MinterResponse {
                minter: msg.creator.clone(),
                cap: Some(Uint128::from(10000u128)),
            })
        }
    )?)
}
...
pub fn query(deps: Deps, _env: Env, msg: QueryMsg) -> StdResult<Binary> {
    match msg {
        ...
        QueryMsg::TokenInfo {} => to_binary(&query_get_token_info(deps)?),
    }
}
